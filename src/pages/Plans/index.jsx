          ...
          <div className="plans_wrapper">
            <div className="plans_wrapper_head">
              ...
              <p className="head-subtitle">
                {this.getLangText("1-PlansSubtitle")}
              </p>
              <p className="head-subtitle">
                {this.getLangText("2-PlansSubtitle")}
              </p>
            </div>
              ...
              <div className="container-item" id="item-standard">
                <div className="container-item_content">
                  <div className="container-item_content_header">
                    <h2 id="unique-item-paragraph">
                      {this.getLangText("Standard")}
                    </h2>
                  ...
                  <div className="container-item_content_footer">
                    <input
                      type="button"
                      className="container-item_content_footer_btn"
                      target="_blank"
                      rel="noopener noreferrer"
                      id="unique-item-button"
                      onClick={() => {
                        popUpManipulations();
                        window.gtag("event", "Choose Free Plan click", {
                          event_category: "Landing. Plans",
                        });
                      }}
                      value={this.getLangText("ButtonName")}
                    ></input>
                  </div>
                </div>
              </div>
                ...
                <div className="container-item_content">
                  ...
                  <div className="container-item_content_footer">
                    <input
                      ...
                      onClick={() => {
                        popUpManipulations();
                        window.gtag("event", "Choose Premium(month) click", {
                          event_category: "Landing. Plans",
                        });
                      }}
                      value={this.getLangText("ButtonName")}
                ...
                <div className="container-item_content">
                  ...
                  <div className="container-item_content_footer">
                    <input
                      ...
                      onClick={() => {
                        popUpManipulations();
                        window.gtag("event", "Choose Premium(year) click", {
                          event_category: "Landing. Plans",
                        });
                      }}
                      value={this.getLangText("ButtonName")}
